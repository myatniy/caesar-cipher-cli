...
function doTheThang(savPath, srcPath) {
  fs.readFile(srcPath, function(err, data) {
    if (err) {
      error(
        `Can't find "${chalk.bold.bgYellowBright.red(program.input)}" file.`
      );
